...
OUTPUT_DIR = Path(f"{START_DATE}-outputs_option2_v5_9b_cvar_15_holdings")
...
def main() -> None:
    ...
    print(f"\nRunning Option 2 V5.9b Classic CVaR Sharpe 15-holding-pruned backtest with {len(rebalance_dates)} rebalance dates...")
