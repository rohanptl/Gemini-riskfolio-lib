...
TRADEABLE_MIN_WEIGHT = 0.01  # cleaner display threshold
...
MAX_FINAL_HOLDINGS_AFTER_PRUNE = 20
...
OUTPUT_DIR = Path("outputs_option2_v5_6_pruned")
...
def main() -> None:
    ...
    print(f"\nRunning Option 2 V5.6 turnover-capped + tiny-position-pruned backtest with {len(rebalance_dates)} rebalance dates...")
